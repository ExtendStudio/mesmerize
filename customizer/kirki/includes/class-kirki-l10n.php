	...
	class Kirki_l10n {
		...
		public static function get_strings( $config_id = 'global' ) {
			...
			$translation_strings = array(
				...
				'ultra-light'           => esc_attr__( 'Ultra-Light 100', 'mesmerize' ),
				'ultra-light-italic'    => esc_attr__( 'Ultra-Light 100 Italic', 'mesmerize' ),
				'light'                 => esc_attr__( 'Light 200', 'mesmerize' ),
				'light-italic'          => esc_attr__( 'Light 200 Italic', 'mesmerize' ),
				'book'                  => esc_attr__( 'Book 300', 'mesmerize' ),
				'book-italic'           => esc_attr__( 'Book 300 Italic', 'mesmerize' ),
				...
				'ultra-bold'            => esc_attr__( 'Ultra-Bold 900', 'mesmerize' ),
				'ultra-bold-italic'     => esc_attr__( 'Ultra-Bold 900 Italic', 'mesmerize' ),
